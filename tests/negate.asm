...
# 	ori	$2,_tmp_24_,0
	jal	putstring
# was:	jal	putstring, $2
# 	ori	_And_L_33_,_letBind_20_,0
	ori	$2, $0, 0
# was:	ori	_falseReg_35_, $0, 0
	ori	$3, $0, 0
# was:	ori	_And_L_30_, $0, 0
	beq	$16, $2, _false_36_
# was:	beq	_And_L_33_, _falseReg_35_, _false_36_
# 	ori	_And_R_34_,_letBind_20_,0
	beq	$16, $2, _false_36_
# was:	beq	_And_R_34_, _falseReg_35_, _false_36_
	ori	$3, $0, 1
# was:	ori	_And_L_30_, $0, 1
_false_36_:
	ori	$4, $0, 0
# was:	ori	_falseReg_32_, $0, 0
	ori	$2, $0, 0
# was:	ori	_And_L_27_, $0, 0
	beq	$3, $4, _false_37_
# was:	beq	_And_L_30_, _falseReg_32_, _false_37_
# 	ori	_And_R_31_,_letBind_20_,0
	beq	$16, $4, _false_37_
# was:	beq	_And_R_31_, _falseReg_32_, _false_37_
	ori	$2, $0, 1
# was:	ori	_And_L_27_, $0, 1
_false_37_:
	ori	$4, $0, 0
# was:	ori	_falseReg_29_, $0, 0
	ori	$3, $0, 0
# was:	ori	_letBind_26_, $0, 0
	beq	$2, $4, _false_38_
# was:	beq	_And_L_27_, _falseReg_29_, _false_38_
# 	ori	_And_R_28_,_letBind_20_,0
	beq	$16, $4, _false_38_
# was:	beq	_And_R_28_, _falseReg_29_, _false_38_
	ori	$3, $0, 1
